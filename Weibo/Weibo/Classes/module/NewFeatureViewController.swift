...
class NewFeatureViewController: UICollectionViewController {
    ...
    // 提示：从 iOS 7.0 开始，就不建议在 viewDidLoad 中设置控件大小和位置 在viewWillAppear中写
...
class NewFeatureCell: UICollectionViewCell {
    ...
    func startButtonClicked() {
        ...
        NSNotificationCenter.defaultCenter().postNotificationName(YTSwitchRootVCNotification, object: true)
    }
