...
// FFAutoLayout
#define COCOAPODS_POD_AVAILABLE_FFAutoLayout
#define COCOAPODS_VERSION_MAJOR_FFAutoLayout 1
#define COCOAPODS_VERSION_MINOR_FFAutoLayout 0
#define COCOAPODS_VERSION_PATCH_FFAutoLayout 1
